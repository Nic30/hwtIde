...
function ComponentDiagram(selector){ 
    ...
    var self = {
        ...
        'bindData': function(nodes, links) {
            ...
            //const forceX = d3.forceX(0)
            //                 .strength(0)
            //const forceY = d3.forceY(0)
            //                 .strength(0)
            //
            ...
            //    .force("center", d3.forceCenter(self.place.width / 2,
            //    		                        self.place.height / 2))
            ...
            //EXTERNAL PORTS    
            drawExternalPorts(svgGroup,
            		self.nodes.filter(function (n){
